...
class CardCreate(Card):
    ...
    card_type: str = Field(description="Tipo informado por la fuente externa.")
    race: str = Field(description="Raza o categoría informada por la fuente externa.")
    name: str = Field(description="Nombre oficial de la carta.")
    text: str = Field(description="Texto o efecto oficial de la carta.")
    attribute: str = Field(description="Atributo informado por la fuente externa.")
